...
The combined dataset shows that there are 99,485 rows and 9 variables. The additional variables added during merging process was month and year so I can identify which original dataset the data came from.
